...
When you ask a question, Trinity AI will search through the
document chunks and find the most relevant ones using the vector index.
Then, it will use GPT4 to generate a final answer.

## Is my data safe?
Yes, your data is safe. Trinity AI does not store your documents or
...
No, the answers are not 100% accurate. Trinity AI uses GPT-4 to generate
answers. GPT-4 is a powerful language model, but it sometimes makes mistakes 
and is prone to hallucinations. Also, Trinity AI uses semantic search
...
But for most use cases, Trinity AI is very accurate and can answer
