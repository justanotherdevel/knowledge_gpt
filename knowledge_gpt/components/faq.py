...
No, the answers are not 100% accurate. NHAI AI uses GPT-4 to generate
answers. GPT-4 is a powerful language model, but it sometimes makes mistakes 
and is prone to hallucinations. Also, NHAI AI uses semantic search
...
But for most use cases, NHAI AI is very accurate and can answer
